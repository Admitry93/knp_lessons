...
$serviceContainer = new ServiceContainer( $configArr );

$shipLoader = $serviceContainer->getShipLoader();
...
$ship1 = $shipLoader->findById( $ship1Id );
$ship2 = $shipLoader->findById( $ship2Id );
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a href="/knp/course1/start/index.php"><p class="text-center"><i class="fa fa-undo"></i> Battle again</p></a>
